...
<OptionBar>
    ...
    <SwitchSetting title="仅显示正版" bind:value={premiumOnly}/>
    <SwitchSetting title="仅显示收藏" bind:value={favoritesOnly}/>
    <MultiSelect title="账户类型" options={["Mojang", "TheAltening"]} bind:values={accountTypes}/>
</OptionBar>
    ...
    {#each renderedAccounts as account}
        <MenuListItem
            ...
            <svelte:fragment slot="tag">
                <MenuListItemTag text={account.type === "Cracked" ? "离线" : account.type}/>
            </svelte:fragment>
...
<BottomButtonWrapper>
    <ButtonContainer>
        ...
        <IconTextButton icon="icon-refresh.svg" title="恢复" on:click={restoreSession}/>
    </ButtonContainer>
